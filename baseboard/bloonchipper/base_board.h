...
#ifndef __CROS_EC_BASEBOARD_BLOONCHIPPER_BASE_BOARD_H
#define __CROS_EC_BASEBOARD_BLOONCHIPPER_BASE_BOARD_H
...
#endif /* __CROS_EC_BASEBOARD_BLOONCHIPPER_BASE_BOARD_H */
