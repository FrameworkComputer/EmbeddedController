...
#ifdef CHIP_VARIANT_MT8195
	{ CONFIG_DRAM_BASE, CONFIG_PANIC_DRAM_BASE, MPU_ATTR_C | MPU_ATTR_W | MPU_ATTR_R },
	/* PANIC region doesn't need cache */
	{ CONFIG_PANIC_DRAM_BASE, CONFIG_DRAM_BASE + CONFIG_DRAM_SIZE, MPU_ATTR_W | MPU_ATTR_R },
#else
