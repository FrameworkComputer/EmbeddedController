 ...
 * (5) 0x11400000
 * MT8195 core0
 * (1) 0x10000000 0x7FF000
 * (2) 0x107FF000 0
 * (3) 0x107FF000 0x1000
 * (4) 0x10800000 0xC00000
 * (5) 0x11400000
 * MT8195 core1
...
#define DRAM_NC_SIZE 0x0
#define CONFIG_PANIC_DRAM_SIZE 0x00001000 /* 4K */
#define KERNEL_SIZE 0x05000000 /* 80 MB */
#define DRAM_TOTAL_SIZE 0x0F000000 /* 240 MB */
#else
...
#define DRAM_TOTAL_SIZE 0x800000 /* 8 MB */
