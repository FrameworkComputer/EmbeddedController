...
static union gladios_cbi_fw_config fw_config;
BUILD_ASSERT(sizeof(fw_config) == sizeof(uint32_t));

/*
 * FW_CONFIG defaults for gladios if the CBI.FW_CONFIG data is not
 * initialized.
 */
static const union gladios_cbi_fw_config fw_config_defaults = {
	.bj_power = BJ_65W,
	.storage = EMMC,
	.fvm_support = FVM_NO,
};
