...
#define TEMP_MINIDP_REG_ADDR	((0x46 << 1) | I2C_FLAG_BIG_ENDIAN)
#define TEMP_HINGE_REG_ADDR	((0x44 << 1) | I2C_FLAG_BIG_ENDIAN)
#define TEMP_AMBIENT_REG_ADDR	((0x42 << 1) | I2C_FLAG_BIG_ENDIAN)
...
#define TEMP_MINIDP_ADDR TMP006_ADDR(I2C_PORT_THERMAL, TEMP_MINIDP_REG_ADDR)
#define TEMP_HINGE_ADDR TMP006_ADDR(I2C_PORT_THERMAL, TEMP_HINGE_REG_ADDR)
#define TEMP_AMBIENT_ADDR TMP006_ADDR(I2C_PORT_THERMAL, TEMP_AMBIENT_REG_ADDR)
...
#endif
#ifdef CONFIG_TMP006
	{"I2C_DCJack-Die", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_IGNORED,
	 tmp006_get_val, 8, 7},
	{"I2C_DCJack-Object", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_IGNORED,
	 tmp006_get_val, 9, 7},
	{"I2C_MiniDP-Die", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_IGNORED,
	 tmp006_get_val, 10, 7},
	{"I2C_MiniDP-Object", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_IGNORED,
	 tmp006_get_val, 11, 7},
	{"I2C_Hinge-Die", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_IGNORED,
	 tmp006_get_val, 12, 7},
	{"I2C_Hinge-Object", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_IGNORED,
	 tmp006_get_val, 13, 7},
	{"I2C_Ambient-Die", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_IGNORED,
	 tmp006_get_val, 14, 7},
	{"I2C_Ambient-Object", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_IGNORED,
	 tmp006_get_val, 15, 7},
#endif
};
...
const struct tmp006_t tmp006_sensors[TMP006_COUNT] = {
	...
	{"DCJack", TEMP_DCJACK_ADDR, 6400},
	{"MiniDP", TEMP_MINIDP_ADDR, 6400},
	{"Hinge", TEMP_HINGE_ADDR, 6400},
	{"Ambient", TEMP_AMBIENT_ADDR, 6400},
};
