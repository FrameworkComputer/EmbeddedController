...
/*omnigul keyboard without numpad and search key on KSI0KSO1*/
static uint16_t omnigul_scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
...
/*omniknight keyboard with numpad and search key on KSI3KSO0*/
static uint16_t omniknight_scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
	{ 0x0000, 0x0000, 0x0014, 0xe01f, 0xe014, 0x0000, 0x0000, 0x0000 },
	{ 0x0000, 0x0076, 0x000d, 0x000e, 0x001c, 0x001a, 0x0016, 0x0015 },
	{ 0x0005, 0x000c, 0x0004, 0x0006, 0x0023, 0x0021, 0x0026, 0x0024 },
	{ 0x0032, 0x0034, 0x002c, 0x002e, 0x002b, 0x002a, 0x0025, 0x002d },
	{ 0x000a, 0x0083, 0x000b, 0x0003, 0x001b, 0x0022, 0x001e, 0x001d },
	{ 0x0051, 0x0000, 0x005b, 0x0000, 0x0042, 0x0041, 0x003e, 0x0043 },
...
void set_keyboard_scancode_set2(void)
{
	if (!ec_cfg_has_keyboard_numpad())
		scancode_set2 = omnigul_scancode_set2;
	else
		scancode_set2 = omniknight_scancode_set2;
}
