...
#define NPCX_RAM_LK_CTL REG8(NPCX_MDC_BASE_ADDR + 0x02F)
#define NPCX_RAM_WRITE_LOCK(n) REG8(NPCX_MDC_BASE_ADDR + 0x050 + (n))
#define NPCX_RAM_FETCH_LOCK(n) REG8(NPCX_MDC_BASE_ADDR + 0x070 + (n))
#define NPCX_RAM_LK_FIELD FIELD(0, 8)
#define NPCX_WLK_BF_EN 0
#define NPCX_FETCH_BF_EN 1
