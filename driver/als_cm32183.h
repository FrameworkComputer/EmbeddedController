...
#define CM32183_REG_CONFIGURE_ALS_INTEGRATION_SET100	0
#define CM32183_REG_CONFIGURE_ALS_INTEGRATION_SET200	1
#define CM32183_REG_CONFIGURE_ALS_INTEGRATION_SET400	2
#define CM32183_REG_CONFIGURE_ALS_INTEGRATION_SET800	3
/*
 * ALS interrupt persistence setting.The interrupt pin is
 * triggered while sensor reading is out of threshold sindows
...
/*
 * how to power on and shutdown serson (BIT 0)
 * 0   power on
 * 1   shutdown
 */
 ...
 * initial as 0x00C0, refresh time is 1300ms, about 700mhz
 */
#define CM32183_LIGHT_MIN_FREQ			200
#define CM32183_LIGHT_MAX_FREQ			1500
