...
enum cbi_data_tag {
	...
	CBI_TAG_BATT_PRECHARGE_VOLTAGE_CURRENT,
	CBI_TAG_BATT_START_CHARGING_MIN_MAX_C,
	CBI_TAG_BATT_CHARGING_MIN_MAX_C,
	CBI_TAG_BATT_DISCHARGING_MIN_MAX_C,
	CBI_TAG_COUNT,
};
