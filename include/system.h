...
enum system_bbram_idx {
	...
	SYSTEM_BBRAM_IDX_CHARGE_LIMIT_MAX,
	SYSTEM_BBRAM_IDX_FP_LED_LEVEL,
	SYSTEM_BBRAM_IDX_KBSTATE,
	SYSTEM_BBRAM_IDX_BIOS_FUNCTION,
	SYSTEM_BBRAM_IDX_CHASSIS_WAS_OPEN,
	SYSTEM_BBRAM_IDX_CHASSIS_MAGIC,
