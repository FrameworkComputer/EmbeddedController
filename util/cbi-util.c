...
static const char *field_name[] = {
	...
	CBI_FIELD_NAME_ENTRY(BATT_SHIP_MODE_REG_ADDR),
	CBI_FIELD_NAME_ENTRY(BATT_SHIP_MODE_REG_DATA),
	CBI_FIELD_NAME_ENTRY(BATT_SLEEP_MODE),
	CBI_FIELD_NAME_ENTRY(BATT_FET_REG_ADDR),
	CBI_FIELD_NAME_ENTRY(BATT_FET_REG_MASK),
	CBI_FIELD_NAME_ENTRY(BATT_FET_DISCONNECT_VAL),
	CBI_FIELD_NAME_ENTRY(BATT_FET_CFET_MASK),
	CBI_FIELD_NAME_ENTRY(BATT_FET_CFET_OFF_VAL),
	CBI_FIELD_NAME_ENTRY(FUEL_GAUGE_FLAGS),
	CBI_FIELD_NAME_ENTRY(FUEL_GAUGE_MANUF_NAME),
	CBI_FIELD_NAME_ENTRY(FUEL_GAUGE_DEVICE_NAME),
	CBI_FIELD_NAME_ENTRY(BATT_VOLTAGE_MAX),
	CBI_FIELD_NAME_ENTRY(BATT_VOLTAGE_NORMAL),
	CBI_FIELD_NAME_ENTRY(BATT_VOLTAGE_MIN),
	CBI_FIELD_NAME_ENTRY(BATT_PRECHARGE_VOLTAGE_CURRENT),
	CBI_FIELD_NAME_ENTRY(BATT_START_CHARGING_MIN_MAX_C),
	CBI_FIELD_NAME_ENTRY(BATT_CHARGING_MIN_MAX_C),
	CBI_FIELD_NAME_ENTRY(BATT_DISCHARGING_MIN_MAX_C),
};
