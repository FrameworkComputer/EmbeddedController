...
/* Increase argument encoding buffer (default 52) to handle the long strings
 * generated by EC code, such as port80 output */
#define PW_LOG_TOKENIZED_ENCODING_BUFFER_SIZE_BYTES 80
...
/* Increase PW FLAG_BITS from 2 to 13.
 ...
 * channels.
 * Zero out LINE_BITS and reallocate to FLAG_BITS, line numbers cause issues
 * when comparing builds and are not used in EC logging.
 */
#define PW_LOG_TOKENIZED_FLAG_BITS 13
