...
/*
 * BQ25770 ChargeOption0 Register (0x12)
 */
#define BQ25770_CHARGE_OPTION_0_RESET_VALUE 0xE70E

/*
 * BQ25770 ChargeOption4 Register (0x36)
 */
#define BQ25770_CHARGE_OPTION_4_IDCHG_DEG2_5P2MS	(2 << 6)
#define BQ25770_CHARGE_OPTION_4_PP_IDCHG2			BIT(2)

/*
 * BQ25770 ProchotOption1 Register (0x34)
 */
#define BQ25770_PROCHOT_OPTION_1_IDCHG_DEGLITCH_5S	(2 << 8)
#define BQ25770_PROCHOT_OPTION_1_PP_ICRIT			BIT(5)
#define BQ25770_PROCHOT_OPTION_1_PP_INOM			BIT(4)
#define BQ25770_PROCHOT_OPTION_1_PP_IDCHG1			BIT(3)
