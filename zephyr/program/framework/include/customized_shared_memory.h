...
#define EC_CUSTOMIZED_MEMMAP_DGPU_SUPPORT_FUNCTION	0x193
#define NV_DGPU_GC6_ENTRY     BIT(3)
#define NV_DGPU_GC6_EXIT     BIT(4)

#define EC_CUSTOMIZED_MEMMAP_DDS_PWM_SOURCING	0x195
#define DDS_PWM_EC_CONTROL     BIT(0)

#define EC_CUSTOMIZED_MEMMAP_DDS_PWM_DUTY	0x196
