...
enum ps2_mouse_task_evt {
	...
	PS2MOUSE_EVT_POWER_RESUME = BIT(2),
	PS2MOUSE_EVT_POWER_SUSPEND = BIT(3),
	PS2MOUSE_EVT_REENABLE = BIT(4),
	PS2MOUSE_EVT_AUX_DATA = BIT(5),
	PS2MOUSE_EVT_HC_DISABLE = BIT(6),
	PS2MOUSE_EVT_HC_ENABLE = BIT(7),
