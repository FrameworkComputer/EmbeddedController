...
#define RAA489300_REG_OUTPUT_VOLTAGE_4P8V		0x0C80
...
#define RAA489300_C3_SWITCHING_FREQ_300K	(0 << 2)
#define RAA489300_C3_SWITCHING_FREQ_400K	(1 << 2)
