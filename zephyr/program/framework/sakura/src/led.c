...
static void board_increase_led_duty(void)
{
	...
	/* WIHTE */
	white_color[LED_PWMS_COLOR_RED] = 4;
	white_color[LED_PWMS_COLOR_GREEN] = 10;
	white_color[LED_PWMS_COLOR_BLUE] = 5;
...
static void board_decrease_led_duty(void)
{
	...
	/* WIHTE */
	white_color[LED_PWMS_COLOR_RED] = 3;
	white_color[LED_PWMS_COLOR_GREEN] = 5;
	white_color[LED_PWMS_COLOR_BLUE] = 3;
	led_change_color(LED_WHITE, EC_LED_ID_BATTERY_LED, sizeof(white_color), white_color);
}
