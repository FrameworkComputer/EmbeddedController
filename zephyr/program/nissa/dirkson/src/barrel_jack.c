...
/******************************************************************************/
/*
 * Since dirkson has no battery, it must source all of its power from either
 * USB-C or the barrel jack (preferred). Dirkson operates in continuous safe
...
/*
 * Dirkson can be powered by BJ adapter and USBC adapter. We
