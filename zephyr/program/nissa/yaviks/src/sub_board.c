...
test_export_static enum yaviks_sub_board_type yaviks_cached_sub_board =
	YAVIKS_SB_UNKNOWN;
/*
...
enum yaviks_sub_board_type yaviks_get_sb_type(void)
{
	 ...
	 * Return cached value.
	 */
	if (yaviks_cached_sub_board != YAVIKS_SB_UNKNOWN)
 ...
 */
static void yaviks_subboard_config(void)
{
	enum yaviks_sub_board_type sb = yaviks_get_sb_type();
...
DECLARE_HOOK(HOOK_INIT, yaviks_subboard_config, HOOK_PRIO_POST_FIRST);
