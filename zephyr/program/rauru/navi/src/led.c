...
/* Navi LED settings: 2 LEDs on board for battery.
 * Battery LEDs is green and red on board.
 */
...
__override void led_set_color_battery(enum ec_led_colors color)
{
	...
	case EC_LED_COLOR_RED:
		gpio_pin_set_dt(GPIO_DT_FROM_NODELABEL(gpio_ec_led1_odl),
				LED_ON_LVL);
		gpio_pin_set_dt(GPIO_DT_FROM_NODELABEL(gpio_ec_led2_odl),
				LED_OFF_LVL);
		break;
