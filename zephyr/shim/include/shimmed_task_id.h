...
enum {
	...
	EC_TASK_FPSENSOR_PRIO, // 25
	EC_TASK_PCHG_PRIO, // 24
	EC_TASK_CHG_RAMP_PRIO, // 23
	EC_TASK_USB_CHG_PRIO, // 22
	EC_TASK_DPS_PRIO, // 21
	EC_TASK_CHARGER_PRIO, // 20
	EC_TASK_CEC_PRIO, // 19
	EC_TASK_CHIPSET_PRIO, // 18
	EC_TASK_MOTIONSENSE_PRIO, // 17
	EC_TASK_USB_MUX_PRIO, // 16
	EC_TASK_HOSTCMD_PRIO, // 15
	EC_TASK_AP_PWRSEQ_PRIO, // 14
	EC_TASK_KEYPROTO_PRIO, // 13
	EC_TASK_POWERBTN_PRIO, // 12
	EC_TASK_KEYSCAN_PRIO, // 11
	EC_TASK_USBPD_ALTMODE_INTEL_PRIO, // 10
	EC_TASK_PD_C0_PRIO, // 9
	EC_TASK_PD_C1_PRIO, // 8
	EC_TASK_PD_C2_PRIO, // 7
	EC_TASK_PD_C3_PRIO, // 6
	EC_TASK_PD_INT_SHARED_PRIO, // 5
	EC_TASK_PD_INT_C0_PRIO, // 4
	EC_TASK_PD_INT_C1_PRIO, // 3
	EC_TASK_PD_INT_C2_PRIO, // 2
	EC_TASK_PD_INT_C3_PRIO, // 1
	EC_TASK_USBC_PDC_PRIO, // 0
	EC_TASK_PRIO_COUNT,
};
