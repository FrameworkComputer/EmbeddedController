...
enum {
	...
	EC_SYSWORKQ_PRIO = EC_TASK_PRIO_LOWEST, // 26
	EC_SHELL_PRIO, // 25
	EC_TASK_RWSIG_PRIO, // 24
	EC_TASK_TOUCHPAD_PRIO, // 23
	EC_TASK_FPSENSOR_PRIO, // 22
	EC_TASK_PCHG_PRIO, // 21
	EC_TASK_CHG_RAMP_PRIO, // 20
	EC_TASK_USB_CHG_PRIO, // 19
	EC_TASK_DPS_PRIO, // 18
	EC_TASK_CHARGER_PRIO, // 17
	EC_TASK_CEC_PRIO, // 16
	EC_TASK_CHIPSET_PRIO, // 15
	EC_TASK_MOTIONSENSE_PRIO, // 14
	EC_TASK_USB_MUX_PRIO, // 13
	EC_TASK_HOSTCMD_PRIO, // 12
