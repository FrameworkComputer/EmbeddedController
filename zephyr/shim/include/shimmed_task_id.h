...
enum {
	...
	EC_SYSWORKQ_PRIO = EC_TASK_PRIO_LOWEST, // 27
	EC_SHELL_PRIO, // 26
	EC_TASK_RWSIG_PRIO, // 25
	EC_TASK_TOUCHPAD_PRIO, // 24
	EC_TASK_FPSENSOR_PRIO, // 23
	EC_TASK_PCHG_PRIO, // 22
	EC_TASK_CHG_RAMP_PRIO, // 21
	EC_TASK_USB_CHG_PRIO, // 20
	EC_TASK_DPS_PRIO, // 19
	EC_TASK_CHARGER_PRIO, // 18
	EC_TASK_CEC_PRIO, // 17
	EC_TASK_CHIPSET_PRIO, // 16
	EC_TASK_MOTIONSENSE_PRIO, // 15
	EC_TASK_USB_MUX_PRIO, // 14
	EC_TASK_HOSTCMD_PRIO, // 13
	EC_TASK_AP_PWRSEQ_PRIO, // 12
	EC_TASK_KEYPROTO_PRIO, // 11
	EC_TASK_POWERBTN_PRIO, // 10
	EC_TASK_KEYSCAN_PRIO, // 9
