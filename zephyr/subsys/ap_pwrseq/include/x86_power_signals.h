...
#define MASK_VW_POWER                          \
	(POWER_SIGNAL_MASK(PWR_RSMRST_PWRGD) | \
	 POWER_SIGNAL_MASK(PWR_DSW_PWROK) | POWER_SIGNAL_MASK(PWR_SLP_SUS))
#define VALUE_VW_POWER \
	(POWER_SIGNAL_MASK(PWR_RSMRST_PWRGD) | POWER_SIGNAL_MASK(PWR_DSW_PWROK))
...
#define MASK_S5                                                             \
	(POWER_SIGNAL_MASK(PWR_RSMRST_PWRGD) |                              \
	 POWER_SIGNAL_MASK(PWR_DSW_PWROK) | POWER_SIGNAL_MASK(PWR_SLP_S3) | \
	 POWER_SIGNAL_MASK(PWR_SLP_S4) | POWER_SIGNAL_MASK(PWR_SLP_S5))
...
#define MASK_VW_POWER POWER_SIGNAL_MASK(PWR_RSMRST_PWRGD)
#define VALUE_VW_POWER POWER_SIGNAL_MASK(PWR_RSMRST_PWRGD)
...
#define MASK_S5                                                                \
	(POWER_SIGNAL_MASK(PWR_RSMRST_PWRGD) | POWER_SIGNAL_MASK(PWR_SLP_S3) | \
	 POWER_SIGNAL_MASK(PWR_SLP_S4) | POWER_SIGNAL_MASK(PWR_SLP_S5))
#define VALUE_S5 MASK_S5
