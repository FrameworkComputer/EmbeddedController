...
ZTEST_SUITE(lotso_keyboard, NULL, NULL, NULL, NULL, NULL);

ZTEST(lotso_keyboard, test_get_scancode_set2)
{
...
ZTEST(lotso_keyboard, test_set_scancode_set2)
{
...
ZTEST(lotso_keyboard, test_get_keycap_label)
{
...
ZTEST(lotso_keyboard, test_set_keycap_label)
{
