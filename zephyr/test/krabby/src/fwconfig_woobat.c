...
ZTEST_SUITE(woobat_clamshell, NULL, NULL, clamshell_reset, NULL, teardown);
...
ZTEST_SUITE(woobat_main_sensor, NULL, NULL, main_sensor_reset, NULL, teardown);
...
ZTEST_SUITE(woobat_alt_sensor, NULL, NULL, alt_sensor_reset, NULL, teardown);
...
ZTEST(woobat_clamshell, test_tabletmode_disable)
{
...
ZTEST(woobat_clamshell, test_irq_disable)
{
...
ZTEST(woobat_main_sensor, test_woobat_main_sensor)
{
	const struct device *base_imu_gpio = DEVICE_DT_GET(
		DT_GPIO_CTLR(DT_NODELABEL(base_imu_int_l), gpios));
	const gpio_port_pins_t base_imu_pin =
...
ZTEST(woobat_alt_sensor, test_woobat_alt_sensor)
{
	const struct device *base_imu_gpio = DEVICE_DT_GET(
		DT_GPIO_CTLR(DT_NODELABEL(base_imu_int_l), gpios));
	const gpio_port_pins_t base_imu_pin =
...
ZTEST(woobat_alt_sensor, test_woobat_alt_sensor_cbi_fail_form_factor)
{
	const struct device *base_imu_gpio = DEVICE_DT_GET(
		DT_GPIO_CTLR(DT_NODELABEL(base_imu_int_l), gpios));
	const gpio_port_pins_t base_imu_pin =
...
ZTEST(woobat_alt_sensor, test_woobat_alt_sensor_cbi_fail_lid)
{
	const struct device *base_imu_gpio = DEVICE_DT_GET(
		DT_GPIO_CTLR(DT_NODELABEL(base_imu_int_l), gpios));
	const gpio_port_pins_t base_imu_pin =
...
ZTEST(woobat_alt_sensor, test_woobat_alt_sensor_cbi_fail_base)
{
	const struct device *base_imu_gpio = DEVICE_DT_GET(
		DT_GPIO_CTLR(DT_NODELABEL(base_imu_int_l), gpios));
	const gpio_port_pins_t base_imu_pin =
