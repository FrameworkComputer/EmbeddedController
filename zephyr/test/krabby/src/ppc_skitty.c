...
ZTEST(ppc_skitty, test_ppc_init)
{
...
static void *ppc_skitty_init(void)
{
...
static void ppc_skitty_before(void *fixture)
{
	RESET_FAKE(ppc_chip_0_interrupt);
}
ZTEST_SUITE(ppc_skitty, NULL, ppc_skitty_init, ppc_skitty_before, NULL, NULL);
