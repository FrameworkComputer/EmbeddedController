...
ZTEST_SUITE(anraggar, NULL, NULL, test_before, NULL, NULL);
...
ZTEST(anraggar, test_hdmi_power)
{
...
ZTEST(anraggar, test_extpower_is_present)
{
	/* Errors are not-OK */
...
ZTEST(anraggar, test_board_check_extpower)
{
...
ZTEST(anraggar, test_board_hibernate)
{
	board_hibernate();
	zassert_equal(sm5803_hibernate_fake.call_count, 2);
}

ZTEST(anraggar, test_board_vconn_control)
{
...
ZTEST(anraggar, test_pd_check_vbus_level)
{
...
ZTEST(anraggar, test_chargers_suspend)
{
...
ZTEST(anraggar, test_set_active_charge_port)
{
...
ZTEST(anraggar, test_tcpc_get_alert_status)
{
...
ZTEST(anraggar, test_pd_power_supply_reset)
{
...
ZTEST(anraggar, test_pd_set_power_supply_ready)
{
...
ZTEST(anraggar, test_typec_set_source_current_limit)
{
...
ZTEST(anraggar, test_c0_interrupt)
{
...
ZTEST(anraggar, test_usb_c1_interrupt)
{
...
ZTEST(anraggar, test_pd_snk_is_vbus_provided)
{
