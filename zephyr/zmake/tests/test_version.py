...
def test_version_string(fake_date, tmp_path):
    ...
    assert (
        ...
        == "prj-123.456.789-d2021.06.28.031853-c0d52f1"
    )
...
def test_version_string_default(fake_date, tmp_path):
    ...
    assert (
        ...
        == "prj-0.0.0-d2021.06.28.031853-c0d52f1"
    )
...
HEADER_VERSION_STR = "prj-123.456.789-d2021.06.28.031853-c0d52f1"
EXPECTED_HEADER = (
    "/* This file is automatically generated by zmake_tests */\n"
    '#define VERSION "prj-123.456.789-d2021.06.28.031853-c0d52f1"\n'
    '#define CROS_EC_VERSION32 "prj-123.456.789-d2021.06.28.031"\n'
